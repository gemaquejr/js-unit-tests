...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    expect(typeof objetoRetornadoTeste1.fetchMenu).toEqual('function');
    ...
    expect(Object.keys(objetoRetornadoTeste2.fetchMenu())).toEqual(['food', 'drink']);
    ...
    expect(objetoRetornadoTeste3.fetchMenu()).toEqual(objetoQualquer);
    ...
    expect(objetoRetornadoTeste6.consumption).toEqual(['coxinha', 'agua', 'sopa', 'sashimi']);
    ...
    expect(objetoRetornadoTeste8.pay()).toEqual(3.9 + 3.9 + 3.9);
